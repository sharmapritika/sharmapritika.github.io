...
* run *ncdump -h* on the source file, if the masked data does not show as "- -", mask the data properly (see: [link]("https://sharma-bharat.github.io/Posts/../../../mask_fillvalue.md.html")). 
